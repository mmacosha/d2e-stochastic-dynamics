...
train --seed=42 --device=cpu --cfg=d2e-ablate --wandb=online --name=d2d-40GMM-dt_0.01 --overrides="data.p_0.args.std=20,data@data.p_1=40gmm,sampler.plot_limits=[-40, 40],sampler.dt=0.01,buffer=simple"
# train --seed=43 --device=cpu --cfg=d2e-ablate --wandb=online --name=d2d-40GMM-dt_1-normal_std_20 \
#     --overrides="data.p_0.args.std=20,data@data.p_1=40gmm,sampler.plot_limits=[-40, 40],sampler.dt=0.01,buffer=simple" && \
